...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/Components/NPay.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/Components/NPay.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      BasketOverviewRightSide: ['.widget-inner.col-xl-5.widget-prop-xl-auto.col-lg-5.widget-prop-lg-auto.col-md-5.widget-prop-md-auto.col-sm-12.widget-prop-sm-3-1.col-12.widget-prop-3-1', //old Ceres,
      '.checkout-rightside' //new ceres
      ],
      PlaceOrderButtons: ['.widget-place-order', // old ceres
  ...
  computed: {
    checkoutValidation: function checkoutValidation() {
    ...
    contactWish: function contactWish() {
      return vueApp.$store.state.checkout.contactWish;
    },
    customerSign: function customerSign() {
      return vueApp.$store.state.checkout.customerSign;
    },
    shippingPrivacyHintAccepted: function shippingPrivacyHintAccepted() {
    ...
    basketItemQuantity: function basketItemQuantity() {
    ...
    isBasketInitiallyLoaded: function isBasketInitiallyLoaded() {
      return vueApp.$store.state.basket.isBasketInitiallyLoaded;
    },
    CheckoutbillingAddress: function CheckoutbillingAddress() {
      return vueApp.$store.state.address.billingAddress;
    },
    CheckoutDeliveryAddress: function CheckoutDeliveryAddress() {
    ...
    DefaultPlaceOrderButton: function DefaultPlaceOrderButton() {
      return this.MethodIds.includes(this.methodOfPaymentId) ? 'hide' : 'show';
    }
  },
  watch: {
    DefaultPlaceOrderButton: function DefaultPlaceOrderButton(value) {
      this.isNCheckoutVisiable = false;
      this.ShowBasketDetails();
    },
    CheckoutbillingAddress: function CheckoutbillingAddress(value) {
      if (this.isNCheckoutVisiable) {
        this.ShowBasketDetails();
        this.HideNChekout();
      }

      if (!this.is_ApplePay_Visible()) $("li[data-id='".concat(this.ApplePayId, "']")).remove();
    },
    CheckoutDeliveryAddress: function CheckoutDeliveryAddress(value) {
      if (this.isNCheckoutVisiable) {
        this.ShowBasketDetails();
        this.HideNChekout();
      }
    ...
    basketAmount: function basketAmount(value) {
      if (this.isNCheckoutVisiable) {
        this.ShowBasketDetails();
        this.HideNChekout();
      }
    },
    shippingProfileId: function shippingProfileId(value) {
      if (this.isNCheckoutVisiable) {
        this.ShowBasketDetails();
        this.HideNChekout();
      }
    ...
    methodOfPaymentId: function methodOfPaymentId(value) {
      if (this.isNCheckoutVisiable) {
        this.ShowBasketDetails();
        this.HideNChekout();
      }
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      for (var i = 0; i < this.PlaceOrderButtons.length; i++) {
        var _selector = this.PlaceOrderButtons[i];

        if ($(_selector).length > 0) {
          Classes = $(_selector).attr('class');
          break;
        }
      }

      var selector = '.widget-place-order';
      ...
      if (this.DefaultPlaceOrderButton == 'hide') {
        this.PlaceOrderButtons.forEach(function (selector) {
          $(selector).hide();
        });
  ...
  methods: {
    alterNetsDetailsContainer: function alterNetsDetailsContainer() {
      if (this.Icons.length > 0) {
        var element = $("li.method-list-item[data-id='".concat(this.MethodId, "']"));

        if (element.length != 0) {
          var content = element.find('div.content');
          var small = element.find('small');
          var details = small[0];
          var description = small[1] ? '<div>' + small[1].outerHTML + '</div>' : '';
          var newContent = "<div class=\"content new-content\"></div>";
          var name = "<span style=\"margin-right:15px\" >".concat(this.MethodName, "</span>");
          var icons = '';
          this.Icons.forEach(function (icon) {
            var _icon$split = icon.split(','),
                _icon$split2 = _slicedToArray(_icon$split, 2),
                path = _icon$split2[0],
                width = _icon$split2[1];

            icons += "<img src=\"".concat(path, "\" style=\"margin-right:10px\"  width= \"").concat(width, "\" class=\"logo-images\">");
          });
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (_this.validateCheckout()) {
                  _this.showSpin();

                  url = "/rest/io/checkout/payment";
                  payment = Ceres_app_services_ApiService__WEBPACK_IMPORTED_MODULE_0__["default"].post(url);
                  payment.done(function (response) {
                    ...
                    if (paymentType == "continue") {
                      var paymentId = paymentValue;

                      if (!_this.checkoutKey) {
                      ...
                      _this.IntializeNetsPayment(paymentId);
                    }
    ...
    getFormattedLanguage: function getFormattedLanguage() {
      var storeLanguage = window.App.defaultLanguage;
      ...
      return PredefinedLanguage[storeLanguage] ? PredefinedLanguage[storeLanguage] : PredefinedLanguage['en'];
    },
    IntializeNetsPayment: function IntializeNetsPayment(paymentId) {
      var _this2 = this;

      var netsLanguage = this.getFormattedLanguage();
      var checkoutOptions = {
    ...
    PlaceOrder: function PlaceOrder() {
      ...
      Ceres_app_services_ApiService__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, params, options).done(function (response) {//console.log('response execute payment') 
        //console.log(response) 
      }).fail(function (error) {
        window.CeresNotification.error(error);
      }).always(function () {
        (0,Ceres_app_services_UrlService__WEBPACK_IMPORTED_MODULE_1__.navigateTo)('/place-order/');
      });
    },
    ShowNChekout: function ShowNChekout() {
      this.isNCheckoutVisiable = true;
      $('#N-container-div').html('');
      $('#NPayBtn').hide();
      this.hideSpin();
      this.BasketOverviewRightSide.forEach(function (selector) {
    ...
    HideNChekout: function HideNChekout() {
      if (this.SuccessPayId) return true;
      this.isNCheckoutVisiable = false;
      $('#N-container-div').html('');
      this.PlaceOrderButtons.forEach(function (selector) {
        $(selector).hide();
    ...
    ShowBasketDetails: function ShowBasketDetails() {
      var _this3 = this;
      ...
      this.BasketOverviewRightSide.forEach(function (selector) {
        ...
        if (element.length > 0) {
          ...
          _this3.PlaceOrderButtons.forEach(function (selector) {
            $(selector).toggle();
          });
    ...
    CheckBrowser: function CheckBrowser() {
      // Get the user agent string
      var userAgent = navigator.userAgent; // Determine the browser type and version
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/Components/NPay.vue?vue&type=template&id=68283d7a&scoped=true&":
/*!**************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/Components/NPay.vue?vue&type=template&id=68283d7a&scoped=true& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _vm.DefaultPlaceOrderButton == "hide" ? _c("div", {
    "class": _vm.btnStyleOldCeres,
    attrs: {
      id: "NPay"
    }
  }, [_c("button", {
    "class": "btn btn-block  btn-appearance " + _vm.btnStyleNewCeres,
    attrs: {
      id: "NPayBtn"
    },
    on: {
  ...
  }), _vm._v("\n       " + _vm._s(_vm.$translate("Ceres::Template.checkoutBuyNow")) + " \n    ")]), _vm._v(" "), _c("div", {
    attrs: {
      id: "N-container-div"
    }
  })]) : _vm._e();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Components_NPay__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Components/NPay */ "./resources/js/src/Components/NPay.vue");

window.NPay = _Components_NPay__WEBPACK_IMPORTED_MODULE_0__["default"];
Vue.component('ww-widget-paynow', _Components_NPay__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
/***/ "./resources/js/src/Components/NPay.vue":
/*!**********************************************!*\
  !*** ./resources/js/src/Components/NPay.vue ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _NPay_vue_vue_type_template_id_68283d7a_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./NPay.vue?vue&type=template&id=68283d7a&scoped=true& */ "./resources/js/src/Components/NPay.vue?vue&type=template&id=68283d7a&scoped=true&");
/* harmony import */ var _NPay_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./NPay.vue?vue&type=script&lang=js& */ "./resources/js/src/Components/NPay.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _NPay_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _NPay_vue_vue_type_template_id_68283d7a_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _NPay_vue_vue_type_template_id_68283d7a_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "68283d7a",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/src/Components/NPay.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/src/Components/NPay.vue?vue&type=script&lang=js&":
/*!***********************************************************************!*\
  !*** ./resources/js/src/Components/NPay.vue?vue&type=script&lang=js& ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_NPay_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./NPay.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/Components/NPay.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_NPay_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/src/Components/NPay.vue?vue&type=template&id=68283d7a&scoped=true&":
/*!*****************************************************************************************!*\
  !*** ./resources/js/src/Components/NPay.vue?vue&type=template&id=68283d7a&scoped=true& ***!
  \*****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_NPay_vue_vue_type_template_id_68283d7a_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_NPay_vue_vue_type_template_id_68283d7a_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_NPay_vue_vue_type_template_id_68283d7a_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./NPay.vue?vue&type=template&id=68283d7a&scoped=true& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/Components/NPay.vue?vue&type=template&id=68283d7a&scoped=true&");
