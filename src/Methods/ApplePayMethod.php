...
class ApplePayMethod extends BaseMethod
{

  

    const METHOD_KEY = PluginConfiguration::PAYMENT_KEY_APPLEPAY;
    ...
    public function getIcon(string $lang = 'de'): string
    {
        ...
        return $this->app->getUrlPath(strtolower(PluginConfiguration::PLUGIN_NAME)).'/images/icons/svg/'.$icon.'.png';
